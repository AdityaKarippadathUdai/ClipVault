...
export const SnippetGrid: React.FC<SnippetGridProps> = ({
  ...
  // Extract all unique tags and languages from current snippets
  ...
  // Filter snippets based on view, folder, search, tag, language
  ...
  // Sort filtered snippets (Pinned items first)
